...
<ScrollIntoView>
   ...
   <p>The Doughnut Project is a long-time social media darling known for artisan flavors — you’re as likely to come here for their famous “Everything Donut” (sweet cream cheese glaze, sesame, poppy and pepita seeds, garlic, sea salt) as you are a classic glazed. Even during an unstable year for restaurants, TDP has managed to crank out new donuts (Mexican Hot Chocolate! Blueberry Cobbler!) and new cocktail partnerships (The Mimosa Doughnut with Chandon, the Alabama Whiskey Salted Caramel Apple Pie Doughnut with Clyde May) that keep their <a href='https://www.instagram.com/thedoughnutproject/?hl=en' target='blank' style={{color:'blue', fontSize: 16}}>Instagram feed viral </a>and the people — locals and tourists alike — inspired for donuts. 
</p>
...
<p>I seriously appreciate The Doughnut Project for continuing their commitment to creativity, and delivering two fantastic and uniquely different pastries. I would give the  Sticky Toffee Pudding Bun a 4 out of 5, and the Cereal Milk Crunch a 5 (the first ever 5 on this blog). 
