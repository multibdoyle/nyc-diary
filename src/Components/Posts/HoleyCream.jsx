...
<p>So in between the dual stresses of beating the Uber Eats small order fee while also not ordering so much sugar you go to bed wheezing, in comes <a href='https://www.holeycreamnewyorkny.com/' target='blank' style={{color:'blue',fontsize:16}}>Holey Cream</a> — a 3rd Avenue storefront that serves up, among other things, a very hefty donut ice cream sandwich for $8.75 (plus $0.95 for extra toppings). 
...
<p>One recent night, I decided to push the ol' comfort zone a bit by trying Midnight Cookies and Cream —  perhaps different than regular Cookies and Cream! — with a vanilla donut and Heath Bar topping. Consistent with prior experiences, my goods arrived quick — Holey Cream’s speedy delivery times, usually under 30 minutes, are at least part of the reason I keep on coming back. They got me hooked!


</p>
<p>The sandwich arrived very cold, with a little crust of ice covering the donut.
