...
{ render() {
    ...
    <div style={{
      ...
      <p>That job might be done, if you're one of the <a href="https://www.gillibrand.senate.gov/download/new-york-unemployment-report" target="_blank" style={{color: 'blue'}}> 413,800 unemployed</a> among the city's boroughs. The dream might be done - or at least on hold, if you're dream was to work on Broadway. </p>
      <p>But New York is not done. The <a href='https://theinfosphere.org/New_New_York' target="_blank" style={{color: 'blue'}}>New New York</a>, in fact, is likely just beginning.</p>
